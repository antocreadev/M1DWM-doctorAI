...
import { ArrowRight, Calendar, User, MapPin, Phone, Briefcase } from "lucide-react"
      ...
      <Card className="border-teal-200">
        <CardHeader>
          ...
          <CardDescription className="text-teal-700">
            Ces informations nous aideront à personnaliser votre expérience et à adapter nos analyses à votre profil.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="birthdate" className="text-teal-700 flex items-center gap-1">
              ...
              <div className="space-y-2">
                <Label htmlFor="gender" className="text-teal-700 flex items-center gap-1">
            ...
            <div className="space-y-2">
              <Label htmlFor="address" className="text-teal-700 flex items-center gap-1">
            ...
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-teal-700 flex items-center gap-1">
            ...
            <div className="space-y-2">
              <Label htmlFor="occupation" className="text-teal-700 flex items-center gap-1">
